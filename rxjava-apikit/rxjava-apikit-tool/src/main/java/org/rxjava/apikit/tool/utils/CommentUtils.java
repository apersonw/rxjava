...
public class CommentUtils {
     ...
     * 获取注释不包含tag的内容
     */
    public static String getCommentNoTag(Javadoc comment, String start) {
        if (comment == null) {
            return start;
        }
     ...
     * 获取注释不带tabName的内容
     */
    public static String getBaseComment(Javadoc comment, String start) {
        if (comment == null) {
            return start;
        }
        StringBuilder sb = new StringBuilder();
     ...
     * 格式化注释
     */
    private static void formatCommentItem(Javadoc comment, String start, StringBuilder sb, String tagName) {
     ...
     * 获取注释
     */
    public static String getComment(Javadoc comment, String start) {
        if (comment == null) {
            return start;
        }
        StringBuilder sb = new StringBuilder();
     ...
     * 转化注释为map
     */
    public static Map<String, String> toMap(Javadoc comment) {
        if (comment == null) {
