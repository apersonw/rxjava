...
import org.rxjava.third.weixin.cp.api.WxCpTaskCardService;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import static org.rxjava.third.weixin.cp.constant.WxCpApiPathConsts.TaskCard.UPDATE_TASK_CARD;
