...
public interface WxMpMaterialService {
     ...
     *
     * @param mediaType 媒体类型, 请看{@link org.rxjava.third.tencent.weixin.common.api.WxConsts}
     * @param file      文件对象
     ...
     *
     * @param mediaType   媒体类型, 请看{@link org.rxjava.third.tencent.weixin.common.api.WxConsts}
     * @param fileType    文件类型，请看{@link org.rxjava.third.tencent.weixin.common.api.WxConsts}
     ...
     * 接口url格式：https://api.weixin.qq.com/cgi-bin/material/batchget_material?access_token=ACCESS_TOKEN
     *
     * @param type   媒体类型, 请看{@link org.rxjava.third.tencent.weixin.common.api.WxConsts}
     * @param offset 从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
     * @param count  返回素材的数量，取值在1到20之间
     */
